  ...
  return (
    <div className="player-board">
      <section
        ...
        className="line"
      >
        <div>{player2Board[0][2]}</div>
        <div>{player2Board[0][1]}</div>
        <div>{player2Board[0][0]}</div>
        <p>{p2Points[0]}</p>
      </section>
      <section
        ...
        className="line"
      >
        <div>{player2Board[1][2]}</div>
        <div>{player2Board[1][1]}</div>
        <div>{player2Board[1][0]}</div>
        <p>{p2Points[1]}</p>
      </section>
      <section
        ...
        className="line"
      >
        <div>{player2Board[2][2]}</div>
        <div>{player2Board[2][1]}</div>
        <div>{player2Board[2][0]}</div>
        <p>{p2Points[2]}</p>
      </section>
    </div>
  );
