...
export const PlayerOneBoard = () => {
  ...
  const setNumberInRow = ({
    ...
    let updatedArr: any = [player1Board[0], player1Board[1], player1Board[2]];
  ...
  return (
    <div className="player-board">
      <section onClick={() => setNumberInRow({ row: 0, turnToSet: 2 })}>
        <p>{p1Points[0]}</p>
        <div className="line">
          <div>{player1Board[0][0]}</div>
          <div>{player1Board[0][1]}</div>
          <div>{player1Board[0][2]}</div>
        </div>
      </section>
      <section
      ...
      >
        <p>{p1Points[1]}</p>
        <div>{player1Board[1][0]}</div>
        <div>{player1Board[1][1]}</div>
        <div>{player1Board[1][2]}</div>
      </section>
      <section
      ...
      >
        <p>{p1Points[2]}</p>
        <div>{player1Board[2][0]}</div>
        <div>{player1Board[2][1]}</div>
        <div>{player1Board[2][2]}</div>
      </section>
    </div>
  );
};
